...
public class addEmpleado {
       ...
       public void agrega(empleado empleado){
           //conexion a la base de datos
            ...
            con.conectar();
            //INSERT SQL
            String sql = "INSERT INTO public.\"empleados\" (nombre,apellido,direccion,telefono,dui,nit,nip,isss,salario,username,password,email,role)"+"VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)";
            String status = "";
      ...
      // metodo para eliminar  registros en la base de datos 
       public void elimina(empleado empleado) throws SQLException{
           //conexion a base de datos 
            ...
            stmt.execute( "DELETE FROM public.\"empleados\"\n" +
           "WHERE  id_campo="+empleado.codigo+";");             
